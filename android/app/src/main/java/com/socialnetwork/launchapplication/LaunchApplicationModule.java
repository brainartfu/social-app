package com.wpg.socialnetwork.app.android.launchapplication;
...
public class LaunchApplicationModule extends ReactContextBaseJavaModule {
  ...
  //  Intent dialogIntent = new Intent(getReactApplicationContext(), MainActivity.class);
    Intent dialogIntent = getReactApplicationContext().getPackageManager().getLaunchIntentForPackage("com.wpg.socialnetwork.app.android");
